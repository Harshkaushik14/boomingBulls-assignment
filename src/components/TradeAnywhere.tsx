  ...
  return (
    ...
    >
      ...
      <div className="absolute mt-14 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center space-y-4 z-20">
        {/* First Zoomable Image */}
        <div className="group bg-white p-2 w-56 h-56 rounded-2xl overflow-hidden transition-transform duration-500 ease-in-out hover:scale-110">
          <img
            src="https://framerusercontent.com/images/wPXXd95jZIk3zRQtU2enBhy2g8.png"
            alt="Overlay"
            className="w-52 h-52 object-contain mx-auto pointer-events-none"
          />
        </div>
